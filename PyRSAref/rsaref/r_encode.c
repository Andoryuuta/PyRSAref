...
static void EncodeQuantum(unsigned char [4], unsigned char [3]);
static int DecodeQuantum(unsigned char [3], unsigned char [4]);
static void EncodeLastQuantum(unsigned char [4], unsigned char *, unsigned int);
static int DecodeLastQuantum(unsigned char *, unsigned int *, unsigned char [4]);
