...
int R_DigestUpdate(R_DIGEST_CTX *, unsigned char *, unsigned int);
int R_DigestFinal(R_DIGEST_CTX *, unsigned char *, unsigned int *);

int R_SignInit(R_SIGNATURE_CTX *, int);
int R_SignUpdate(R_SIGNATURE_CTX *, unsigned char *, unsigned int);
int R_SignFinal(R_SIGNATURE_CTX *, unsigned char *, unsigned int *, R_RSA_PRIVATE_KEY *);

int R_VerifyInit(R_SIGNATURE_CTX *, int);
int R_VerifyUpdate(R_SIGNATURE_CTX *, unsigned char *, unsigned int);
int R_VerifyFinal(R_SIGNATURE_CTX *, unsigned char *, unsigned int, R_RSA_PUBLIC_KEY *);

int R_SealInit(R_ENVELOPE_CTX *, unsigned char **, unsigned int *, unsigned char [8], unsigned int, R_RSA_PUBLIC_KEY **, int, R_RANDOM_STRUCT *);
int R_SealUpdate(R_ENVELOPE_CTX *, unsigned char *, unsigned int *, unsigned char *, unsigned int);
int R_SealFinal(R_ENVELOPE_CTX *, unsigned char *, unsigned int *);

int R_OpenInit(R_ENVELOPE_CTX *, int, unsigned char *, unsigned int, unsigned char [8], R_RSA_PRIVATE_KEY *);
int R_OpenUpdate(R_ENVELOPE_CTX *, unsigned char *, unsigned int *, unsigned char *, unsigned int);
int R_OpenFinal(R_ENVELOPE_CTX *, unsigned char *, unsigned int *);

/* Cryptographic enhancements by block.
 */
int R_SignPEMBlock(unsigned char *, unsigned int *, unsigned char *, unsigned int *,unsigned char *, unsigned int, int, int, R_RSA_PRIVATE_KEY *);
int R_SignBlock(unsigned char *, unsigned int *, unsigned char *, unsigned int, int, R_RSA_PRIVATE_KEY *);
int R_VerifyPEMSignature(unsigned char *, unsigned int *, unsigned char *, unsigned int, unsigned char *, unsigned int, int, int, R_RSA_PUBLIC_KEY *);
int R_VerifyBlockSignature(unsigned char *, unsigned int, unsigned char *, unsigned int, int, R_RSA_PUBLIC_KEY *);
int R_SealPEMBlock(unsigned char *, unsigned int *, unsigned char *, unsigned int *, unsigned char *, unsigned int *, unsigned char [8], unsigned char *, unsigned int, int, R_RSA_PUBLIC_KEY *, R_RSA_PRIVATE_KEY *, R_RANDOM_STRUCT *);
int R_OpenPEMBlock(unsigned char *, unsigned int *, unsigned char *, unsigned int, unsigned char *, unsigned int, unsigned char *, unsigned int, unsigned char [8], int, R_RSA_PRIVATE_KEY *, R_RSA_PUBLIC_KEY *);
int R_DigestBlock(unsigned char *, unsigned int *, unsigned char *, unsigned int, int);
