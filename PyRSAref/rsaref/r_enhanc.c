...
static void R_EncodeDigestInfo(unsigned char *, int, unsigned char *);
static void EncryptPEMUpdateFinal(R_ENVELOPE_CTX *, unsigned char *, unsigned int *, unsigned char *, unsigned int);
static int DecryptPEMUpdateFinal(R_ENVELOPE_CTX *, unsigned char *, unsigned int *, unsigned char *, unsigned int);
static int CipherInit(R_ENVELOPE_CTX *, int, unsigned char *, unsigned char *, int);
static void CipherUpdate(R_ENVELOPE_CTX *, unsigned char *, unsigned char *, unsigned int);
static void CipherRestart(R_ENVELOPE_CTX *);
...
static int DecryptPEMUpdateFinal (
R_ENVELOPE_CTX *context,
